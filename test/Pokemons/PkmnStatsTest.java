...
public class PkmnStatsTest {
    ...
    public void testLoadPkmnStatsFromFile() throws ReaderException {
        PkmnStats Bulbizarre = Game.getGame().getDatas().getLoadedPkmn("Bulbizarre");
        ...
        //System.out.println("Bulbizarre successfully loaded");
        
        
        PkmnStats Taupiqueur = Game.getGame().getDatas().getLoadedPkmn("Taupiqueur");
        ...
        //System.out.println("Taupiqueur successfully loaded");
        
//        
//        PkmnStats findsNotFittingCases = Game.getGame().getDatas().getLoadedPkmn("taupiqueur");
//        Assert.assertTrue(findsNotFittingCases.getName().equals("Taupiqueur"));
//        //System.out.println("taupiqueur successfully loaded");
//        
        
        for(String pkmnName : PkmnStats.getPOKEDEX()) {
            PkmnStats loadedPkmn = Game.getGame().getDatas().getLoadedPkmn(pkmnName);
