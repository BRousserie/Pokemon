...
public class WildZoneTest
{
    ...
    public void testWildZone()
    {
        ...
        try {
            WildZone route1 = (WildZone) data.getLoadedZone("ROUTE 1");
            Assert.assertEquals("ROUTE 1", route1.name);
            Assert.assertEquals(3, route1.meetingPkmnProba);
            Assert.assertEquals(0, route1.meetingTrainerProba);
            ...
            Assert.assertEquals(7, route1.wildPkmns.size());
            Assert.assertEquals("Roucool", route1.wildPkmns.get(0).getName());

            WildZone route2 = (WildZone) data.getLoadedZone("ROUTE 2");
            Assert.assertEquals("ROUTE 2", route2.name);
            Assert.assertEquals(1, route2.meetingPkmnProba);
            Assert.assertEquals(0, route2.meetingTrainerProba);
            ...
            WildZone route12 = (WildZone) data.getLoadedZone("ROUTE 12");
