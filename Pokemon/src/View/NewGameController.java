...
public class NewGameController implements Initializable
{
    ...
    @FXML
    private Button next, skip, chooseUserInput, chooseRed, chooseSacha,
            choosePaul, chooseUserInputRival, chooseBlue, chooseRegis,
            chooseJean;
    @FXML
    private GridPane QCM1, QCM2;
    @FXML
    private TextField UserInput, UserInputRival;
